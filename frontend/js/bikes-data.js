const bikesData = [
  ...
  {
    id: "bike-20",
    name: "135cc neo plus atv",
    shortDescription: "Premium 135cc Neoplus ATV with backrest, handguard, digital speedometer, remote, and LED lights with extra spotlights.",
    fullDescription: "The 135cc Neoplus ATV is designed for riders seeking the ultimate off-road adventure. Outfitted with high-utility features including a backrest, handguard, digital speedometer, remote control, and powerful LED headlights coupled with dual extra spotlights, it is built to deliver top-tier trail performance and convenience.",
    images: [
      "./public/products/media__1783403320261_page_1.png",
      "./public/products/media__1783403320261_page_2.png",
      "./public/products/media__1783403320261_page_3.png",
      "./public/products/media__1783403320261_page_4.png",
      "./public/products/media__1783403320261_page_5.png"
    ],
    specifications: {
      "Engine Type": "135cc, Single Cylinder, 4-Stroke, Air-Cooled",
      ...
      "Suspension": "Dual Front A-Arm & Rear Monoshock",
    ...
    features: [
      "Backrest and Handguard",
      "Digital Speedometer",
      "Remote Control Kill Switch",
      "LED Light and 2 Extra Spotlights",
      "Durable Front & Rear Utility Racks",
      "Non-slip Footrests"
    ],
